...
## 🧠 Emerging RAG Topics
New patterns changing how agents retrieve and use knowledge.

- [[Page Index vs RAG]] — When to load full docs into context vs. chunking + retrieval
- [[KV Cache Reuse]] — Reuse attention computation across requests to cut latency and cost
